 ...
 * 
 * kltsa 24/02/2014.
 * Changes in the original contrail filter so that is it can use
 * the esgf user table.
...
public class BasicAuthFilter_esgf  implements Filter 
{
  ...
  /* Attributes for storing security, log, contex data.*/
  ...
  /* Process the request after has been processed. 
   * 
   * Input:
  ...
  */
  public void init_old() throws ServletException
  {
    ...
    */
    /* kltsa 14/02/2014: ok lets write some code in java :-)... 
     * Call the object that can connect to database.
     */
    
	if(em == null)
	{	
      emf = Persistence.createEntityManagerFactory("kltsa_test_entity_name");
...
*/  
  ...
  /* Return the configuration of this filter.
   * Input:
   * Output:
   */
