...
/* kltsa 28/02/2014, no issue : Use modified library. */
/*import eu.contrail.security.SecurityCommons;*/
import sec.SecurityCommons_esgf;
/* kltsa 27/02/2014 no issue: Saml is not going to be used ... probably
 ...
 * @author ijj
 */
public class UserCertServlet_esgf extends HttpServlet {
  ...
  private PKCS10CertificationRequest getCSR(final HttpServletRequest request, SecurityCommons_esgf sc)
		  throws IOException {
  ...
  protected void processRequest(
	  ...
	  final SecurityCommons_esgf sc = new SecurityCommons_esgf();
	  ...
	  final String userUUID = user.getOpenid();
	  final String uuid = user.getOpenid();
	  ...
	  try {
		  ...
		  /* kltsa 27/02/2014 no issue : Creation of certificate without salm.*/
		  /*
